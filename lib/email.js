...
function renderAccountDeletedHtml(username) {
  return `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto;">
      ...
      <p>Akun UangKu <strong>${escapeHtml(username)}</strong> dan seluruh datanya (transaksi, profil, koneksi Telegram) telah dihapus permanen.</p>
      <p style="color:#6c757d; font-size: 0.9rem;">Jika ini bukan kamu, kemungkinan akun kamu diakses orang lain — kami tidak bisa memulihkan data yang sudah terhapus.</p>
    </div>
  `;
}
