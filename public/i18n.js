...
(function () {
  ...
  var D = {
    ...
    'set.mfaBackupWarn': { id: 'Simpan kode cadangan ini di tempat aman — hanya ditampilkan sekali ini. Tiap kode bisa dipakai sekali untuk masuk jika kamu kehilangan akses ke authenticator.', en: 'Save these backup codes somewhere safe — they are shown only once. Each code can be used once to sign in if you lose access to your authenticator.', zh: '请将这些备用码保存在安全的地方——它们只显示这一次。若你无法使用身份验证器，每个备用码可用于登录一次。' },
